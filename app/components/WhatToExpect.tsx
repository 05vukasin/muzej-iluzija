...
export default function WhatToExpect() {
  ...
  const title =
    language === "sr" ? "ŠTA TE SVE ČEKA KOD NAS?" : "WHAT AWAITS YOU HERE?";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative">
        <div className="rounded-2xl bg-black/65 backdrop-blur-md text-white shadow-2xl ring-1 ring-white/10 p-6 sm:p-8 lg:p-10">
          ...
          <Link
            href="/illusions"
            prefetch
            className="mt-8 inline-block rounded-full bg-brand-235 text-white px-6 py-3 font-semibold hover:brightness-110 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
            aria-label={
